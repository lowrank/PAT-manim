# Manim Latent Seminar

This repository stores the scripts for videos on the YouTube channel: Latent Seminar. The videos are generated using manim. 

Current list of topics in the video list:
